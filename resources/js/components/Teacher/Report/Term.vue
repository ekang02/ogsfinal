      ...
      <div class="col-sm-5">
        <div class="card shadow">
          ...
          <div class="card-body">
            ...
            <div class="form-group col-sm-12">
              <label>Section</label>
              <select v-model="form.section" class="form-control" @change="getSubjectByTeacherSubject()" :disabled="isSectionDisabled">
            ...
            <div class="form-group col-sm-12">
              <label>Subject</label>
              <select v-model="form.subject" class="form-control" @change="getSubjectSchedule()" :disabled="isSubjectDisabled">
                  <option v-for="sub in subjects" :value="sub.subject"> {{ sub.subject.label }}</option>
              </select>
              <div class="invalid-feedback">This field is required.</div>
            </div>
            <div v-if="form.section !== '' && form.subject !== ''" class="col-sm-12">
...
export default {
  ...
  methods: {
    ...
    compute(){
      ...
      axios.post('/get-compute-quarterly-grade',{
        user_id: self.user.id,
        year_id: self.form.year.id,
        section_id: self.form.section.id,
        subject_id: self.form.subject.id,
    ...
    getGrades(){
      if(this.form.section && this.form.subject){
