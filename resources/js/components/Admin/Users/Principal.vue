<template>
  <div class="">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div>
        <button class="btn btn-success" @click="openModal()">Add New Principal</button>
      </div>        
    </div>
    <hr/>
    <div class="mx-3">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold">Principal List</h6>
        </div>
        <div class="card-body">
    ...
    <modalAddPrincipal v-if="showModalData" :showModalData.sync="showModalData" @close="close"></modalAddPrincipal>
    <modalEditPrincipal v-if="showModalDataEdit" :showModalDataEdit.sync="showModalDataEdit" :selectedData.sync="selectedData" @closeEdit="closeEdit"></modalEditPrincipal>
  </div>
</template>

<script>
import modalAddPrincipal from '../../Modal/modalAddPrincipal.vue';
import modalEditPrincipal from '../../Modal/modalEditPrincipal.vue';
export default {
  props:['user'],
  components: {
    modalAddPrincipal,
  ...
  methods: {
    ...
    del(id){
      var self = this;
      self.$swal({
          title: "Are you sure to delete this Principal?",
