<template>
  <div class="">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div>
        <button class="btn btn-success" @click="openModal()">Add New Assessment Level</button>
      </div>        
    </div>
    <hr/>
    <div class="mx-3">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold">Assessment Level List</h6>
        </div>
        <div class="card-body">
    ...
    <modalAddAssessment v-if="showModalData" :showModalData.sync="showModalData" @close="close"></modalAddAssessment>
    <modalEditAssessment v-if="showModalDataEdit" :showModalDataEdit.sync="showModalDataEdit" :selectedData.sync="selectedData" @closeEdit="closeEdit"></modalEditAssessment>
  </div>
</template>

<script>
import modalAddAssessment from '../../Modal/modalAddAssessment.vue';
import modalEditAssessment from '../../Modal/modalEditAssessment.vue';
export default {
  props:['user'],
  components: {
    modalAddAssessment,
