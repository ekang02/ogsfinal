                  ...
                  <div class="row">
                    <div class="row justify-content-between col-sm-12">
                      ...
                      <div class="form-group col-sm-6">
                          ...
                          <input type="text" v-model="selectedData.user.username" class="form-control"readonly="true">
                      </div>
                    </div>
                    <div class="row justify-content-between col-sm-12">
                      <div class="form-group col-sm-6">
...
export default {
  ...
  data(){
    return {
      ...
      sections: [],
      form:{
        student_id: this.selectedData.student_id,
        year: this.selectedData.year_id,
        section: this.selectedData.section_id,
        first_name: this.selectedData.first_name,
        middle_name: this.selectedData.middle_name,
        last_name: this.selectedData.last_name,
        phone_number: this.selectedData.phone_number,
        age: this.selectedData.age,
        date_of_birth: this.selectedData.date_of_birth,
        gender: this.selectedData.gender,
        address: this.selectedData.address,
        email: this.selectedData.user.email,
        password: '',
      },
      errors: {
        email: [],
