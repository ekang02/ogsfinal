                  ...
                  <div class="row">
                    <div class="row justify-content-between col-sm-12">
                      <div class="form-group col-sm-6">
                        ...
                        <input type="text" v-model="form.student_id" class="form-control" readonly="true" disabled="true">
                      </div>
                      <div class="form-group col-sm-6">
                        <label>Username</label>
                        <input type="text" v-model="selectedData.username" class="form-control" readonly="true" disabled="true">
                      </div>
                    </div>
                    <div class="row justify-content-between col-sm-12">
                      <div class="form-group col-sm-6">
                      ...
                      <div class="form-group col-sm-6">
                          <label>Section</label>
                          <select class="form-control" v-model="form.section" :class="{ 'is-invalid': attemptSubmit && missingSection }">
                            <option v-for="section in sections" :value="section.id" :key="section.id">{{ section.label }}</option>
                          </select>
                          <div class="invalid-feedback">This field is required.</div>
                      </div>
                    </div>
...
export default {
  ...
  data(){
    return {
      ...
      highlighted: {},
      state : {   
        date: this.selectedData.student_info.date_of_birth, 
        disabledDates: {
          from: new Date(),
        }
      }
  ...
  methods: {
    ...
    getSectionByYear(){
      ...
      axios.get('/get-year-section',{
        params:{
          year_id: this.selectedData.student_info.year_id,
    ...
    validateForm: function (event) {
      ...
      if (this.missingGender || this.missingAddress || this.missingFirstName || this.missingLastName || this.missingMobileNumber ||  this.missingEmail || this.missingAge || this.missingBirthDate){
